#!/usr/bin/env python3
"""
Evaluate a trained LoRA (or base model) on KHATT or IFN/ENIT using corpus CER / WER
...
def main() -> None:
    ...
    # Corpus-level (micro) CER/WER: sum(edit ops) / sum(ref length). Do not average
    # per-sample rates — that macro-mean is biased and not the usual OCR metric.
